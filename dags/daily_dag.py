...
with DAG('hourly_dag',default_args={'retries': 5,'retry_delay': timedelta(seconds=30)}, description='Fee model to predict',tags=['pm2.5_dashboard'],schedule_interval='@daily'
